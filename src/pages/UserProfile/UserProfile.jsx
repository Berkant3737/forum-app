...
function UserProfile() {
  return (
    <div>
      ...
      <section>
        <div className="user-profile-content dark-mode">
                        ...
                        <ul className="user-profile-option p-0 mt-4 text-start">
                          <li className="user-profile-option-item m-2 rounded-5">
                            <a href="#" className="btn active">
                              <i className="fa-solid fa-user p-2"></i>Profil
                            </a>
                          </li>
                          <li className="user-profile-option-item m-2 rounded-5">
                            <a href="#" className="btn">
                              <i className="fa-solid fa-heart-circle-plus p-2"></i>
                              Kaydedilenler
                            </a>
                          </li>
                        </ul>
                        ...
                        <div className="row">
                          <div className="col-12">
                            <ul className="social d-flex pt-3 border-top ps-0">
                              <li className="mx-1">
                                <a href="">
                                  <i className="fab fa-facebook-f rounded-3"></i>
                                </a>
                              </li>
                              <li className="mx-1">
                                <a href="">
                                  <i className="fab fa-twitter rounded-3"></i>
                                </a>
                              </li>
                              <li className="mx-1">
                                <a href="">
                                  <i ClassName="fab fa-pinterest rounded-3"></i>
                                </a>
                              </li>
                            </ul>
                          </div>
